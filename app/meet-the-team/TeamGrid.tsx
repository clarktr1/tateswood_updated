          ...
          >
            <div className="relative aspect-[3/4] w-full overflow-hidden">
              ...
              <a
                ...
                className="absolute right-4 top-4 flex h-10 w-10 items-center justify-center bg-orange-surface text-white shadow-md transition-all duration-200 hover:scale-110 hover:bg-accent-orange focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              >
                <MailIcon />
              </a>

              <div className="absolute left-4 top-4 rounded-lg bg-white/95 px-3 py-1.5 shadow-md backdrop-blur-sm">
                <p className="text-lg font-extrabold leading-none text-brand-purple">
                  {member.years}+
                </p>
                <p className="text-[9px] font-semibold uppercase tracking-wide text-foreground/60">
                  Years Exp.
                </p>
              </div>
              ...
              <div className="absolute inset-x-4 bottom-4 border-l-4 border-brand-orange bg-white px-5 py-4 shadow-lg">
                ...
                <h2 className="mt-0.5 text-2xl font-bold text-brand-purple">
                  {member.full_name}
                </h2>
          ...
          >
            ...
            <div className="flex flex-col p-8">
              ...
              <button
                ...
                className="mt-6 inline-flex w-fit items-center gap-2 bg-orange-surface px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-accent-orange focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-purple"
              >
                {copied ? <CheckIcon /> : <MailIcon />}
                {copied ? "Copied!" : "Email Me"}
              </button>
              <span className="sr-only" role="status" aria-live="polite">
                {copied ? `Email address copied: ${selected.email}` : ""}
              </span>
            </div>
          </div>
        </div>
